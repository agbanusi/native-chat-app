    ...
    return(
        <View style={styles.container}>
           ...
           <View style={styles.switch}>
                <Text style={styles.name}>Nothing to see here</Text>
                <Text style={styles.username}>You didn't made any conversation yet, please select username.</Text>
           </View>
        <_Button title="Go to Explore page" onPress={()=>{props.navigation.navigate('Connection')} }style={styles.button} textStyle={styles.buttonText} />
        </View>
    )
}
