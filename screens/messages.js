...
function Rooms (props){
    ...
    useFocusEffect(
        React.useCallback(() => {
          props.changeScreen("Messages")
          props.changeName("Messages")
        },[])
    )
    ...
    return(
        <View style={styles.container}>
           ...
           <View style={styles.switch}>
                <Text style={styles.name}>No Messages</Text>
                <Text style={styles.username}>You didn't made any conversation yet, please select username.</Text>
           </View>
        <_Button title="Start a conversation" onPress={()=>{props.navigation.navigate('Messages')} }style={styles.button} textStyle={styles.buttonText} />
        </View>
    )
}
